      ...
      w = (f.FullscreenApi, {
        ...
        return a(t, e), t.prototype.render = function (t) {
          ...
          if (!g.IS_ENABLED_MSE || !i && !o || g.IS_X5TBS && this.player.options.x5_player || i && g.IS_MAC && g.IS_SAFARI && !g.IS_IOS) this.__type = t, this.el.src = e; else {
            ...
            i ? (this.__type = f.VideoType.M3U8, "undefined" == typeof window.Hls ? h.loadScript(f.unifyProtocol(hls.js文件地址), function () {
    ...
    var c = i(24), u = n(c), p = i(4), h = i(2), d = o(h), f = i(3), y = o(f), A = i(25), v = o(A), m = i(1), g = o(m),
      w = function (e) {
        ...
        return a(t, e), t.prototype.render = function (e) {
          ...
          } else this.__rtmp || (this.__bytesloaded != e.bytesLoaded && (this.__bytesloaded = e.bytesLoaded,
            this.pub({
              type: p.MSG.Progress,
              src: this,
              ts: +new Date
